-- Companion 2.1.14 discovers the LinkedIn Pages administered by a connected
-- profile and publishes only to an explicitly selected personal/Page target.
insert into public.job_control_settings(key, value, updated_at)
values ('minimum_companion_version', '2.1.14', now())
