...
export default async function InstagramScraperPage() {
  const accessUser = await requireAccess("scraping.instagram", "view", "/scraper/instagram");
  const user = await requirePrincipalCapability(accessUser, "scraping.view", "/scraper/instagram");
  return (
    <ProductShell
