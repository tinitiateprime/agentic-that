...
export function facebookRangeCoverage(
  ...
  // Facebook can pin an old post above the current timeline. Use the dated
  // discovery tail to prove progress through the range instead of allowing an
  // isolated old outlier to stop pagination early.
