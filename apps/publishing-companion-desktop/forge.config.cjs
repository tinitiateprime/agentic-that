...
module.exports = {
  packagerConfig: {
    ...
    executableName: "AgenticThat Companion",
    win32metadata: {
      CompanyName: "AgenticThat",
      FileDescription: "AgenticThat local publishing and scraping engine",
      ProductName: "AgenticThat Companion",
      InternalName: "AgenticThatCompanion",
      OriginalFilename: "AgenticThat Companion.exe",
    },
  ...
  makers: [
    {
      ...
      config: {
        ...
        authors: "AgenticThat",
        description: "Local publishing and scraping engine for AgenticThat",
        setupExe: "AgenticThat-Companion-Setup.exe",
    ...
    ...(storePublisher ? [{
      ...
      config: {
        ...
        manifestVariables: {
          ...
          packageDescription: "Local publishing and scraping engine for AgenticThat",
