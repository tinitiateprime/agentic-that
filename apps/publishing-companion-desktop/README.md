...
Version 1.5.0 provides both Instagram and Facebook Local Companion engines.
Public scraping runs in hidden, non-persistent browser partitions that never
reuse or modify the persistent publishing sessions. See
