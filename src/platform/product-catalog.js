...
export const productServices = [
  ...
  {
    slug: "ai-phone-front-desk",
    category: "messaging",
    name: "AI Phone Front Desk",
    platformName: "Phone Front Desk",
    provider: "AgenticThat Voice AI",
    logo: "/ai-phone-front-desk.svg",
    accent: "#0b6c62",
    tint: "#e7f7f3",
    availability: "live",
    connectionKind: "none",
    shortDescription: "Let a business-aware AI receptionist answer a realistic demo call, qualify the caller, capture the lead and prepare an instant summary.",
    promise: "Give every caller a polished first response, even when the team cannot answer the phone.",
    detailHeading: "A natural AI receptionist trained around the business, its services and its response rules",
    detailDescription: "Configure the essentials once, start a browser-based voice call, and watch the assistant answer questions, capture customer needs, prepare bookings and surface calls that need a person.",
    formatLabel: "Live voice · Lead capture · Call summaries",
    dashboardHref: "/phone-front-desk",
    actionLabel: "Open AI Phone Front Desk",
    capabilities: [
      { title: "Natural live conversation", description: "Run a low-latency microphone call with interruption handling and a professional business-branded voice experience." },
      { title: "Business-grounded answers", description: "Use only the services, hours, FAQs and response rules approved in the workspace profile." },
      { title: "Lead and booking capture", description: "Collect the caller's name, number, reason and requested appointment without losing the conversation context." },
      { title: "Instant operational summary", description: "Turn every completed demo call into a searchable transcript, outcome and follow-up summary." },
    ],
    steps: [
      { title: "Teach the receptionist", description: "Add the business name, services, hours, greeting and the important answers callers need." },
      { title: "Start a demo call", description: "Allow microphone access and speak naturally; a typed mode remains available as a dependable fallback." },
      { title: "Review the outcome", description: "See the captured lead, appointment request, transcript and concise follow-up summary immediately." },
    ],
    useCases: ["Live sales demonstrations", "After-hours reception", "Lead qualification", "Appointment requests", "FAQ handling", "Human handoff preparation"],
    requirements: ["A microphone-enabled modern browser for live voice", "Basic business services and hours", "Gemini API access configured by AgenticThat"],
    outcomes: ["Natural demo conversation", "Captured caller details", "Call transcript and summary", "Booking or handoff request"],
    note: "This release is a browser-call demonstration and does not yet answer a public telephone number. Real inbound numbers and live transfers will be connected through a telephony provider after the demo phase.",
  },
  {
    slug: "telegram",
    category: "messaging",
