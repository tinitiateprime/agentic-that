...
export const OPERATIONAL_ROLE_CATALOG = Object.freeze([
  ...
  Object.freeze({ id: "role_publishing_uploader", name: "Content Uploader", description: "Creates content, selects destinations, and hands submissions to a Scheduler.", capabilities: publishingUploader }),
  Object.freeze({ id: "role_publishing_scheduler", name: "Scheduler", description: "Creates schedules and schedules submitted content without changing it.", capabilities: publishingScheduler }),
...
export const SELF_SERVICE_ROLE_CATALOG = Object.freeze([
  ...
  Object.freeze({
    ...
    description: "Create, schedule, publish, and configure all live publishing destinations.",
